...
<<<<<<< HEAD
                  ...
                  searchPlaceholder: transferOwnershipConfiguration?.searchPlaceholder,
                  disableUsersPresence: transferOwnershipConfiguration?.disableUsersPresence ?? false,
                  emptyStateText: transferOwnershipConfiguration?.emptyStateText,
                  errorStateText: transferOwnershipConfiguration?.errorStateText,
                  avatarStyle: transferOwnershipConfiguration?.avatarStyle,
                  emptyStateView: transferOwnershipConfiguration?.emptyStateView,
                  errorStateView: transferOwnershipConfiguration?.emptyStateView,
                  ...
                  groupMembersProtocol: transferOwnershipConfiguration?.groupMembersProtocol,
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) => Scaffold(
                  body: Center(child: Text(Translations.of(context).view_profile)),
                )));
  }
