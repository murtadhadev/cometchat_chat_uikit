                        ...
                        children: [
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  focusedBorder: UnderlineInputBorder(
                                    borderSide: BorderSide(color: theme.palette.getAccent100()),
                                  ),
                                  hintText: widget.namePlaceholderText ?? cc.Translations.of(context).name,
                                  hintStyle: widget.createGroupStyle.namePlaceholderTextStyle ??
                                      TextStyle(
                                        color: theme.palette.getAccent600(),
                                        fontSize: theme.typography.body.fontSize,
                                        fontFamily: theme.typography.body.fontFamily,
                          ...
                          if (createGroupController.groupType == GroupTypeConstants.password)
                            SizedBox(
                              height: 56,
                              child: TextFormField(
                                initialValue: createGroupController.groupPassword,
                                validator: (value) {
                                  if (createGroupController.groupType == GroupTypeConstants.password &&
                                ...
                                decoration: InputDecoration(
                                    ...
                                    hintText: widget.passwordPlaceholderText ?? cc.Translations.of(context).password,
                                    hintStyle: widget.createGroupStyle.passwordPlaceholderTextStyle ??
                                        TextStyle(
                                          color: theme.palette.getAccent600(),
                                          fontSize: theme.typography.body.fontSize,
                                          fontFamily: theme.typography.body.fontFamily,
