...
<<<<<<< HEAD
  ...
  final Widget Function(User? user, Group? group, BuildContext context)? messageComposerView;
...
<<<<<<< HEAD
        user: widget.user, group: widget.group, threadedMessagesConfiguration: widget.threadedMessagesConfiguration);
=======
        user: widget.user,
        group: widget.group,
...
<<<<<<< HEAD
    if ((user != null && user.uid == user.uid) || ((group != null && group.guid == group.guid))) {
=======
...
<<<<<<< HEAD
                          closeButtonIcon: widget.detailsConfiguration?.closeButtonIcon,
                          showCloseButton: widget.detailsConfiguration?.showCloseButton,
                          //stateCallBack: detailsStateCallBack,
                          detailsStyle: widget.detailsConfiguration?.detailsStyle,
                          addMemberConfiguration: widget.detailsConfiguration?.addMemberConfiguration,
                          transferOwnershipConfiguration: widget.detailsConfiguration?.transferOwnershipConfiguration,
                          bannedMemberConfiguration: widget.detailsConfiguration?.bannedMemberConfiguration,
                          appBarOptions: widget.detailsConfiguration?.appBarOptions,
                          avatarStyle: widget.detailsConfiguration?.avatarStyle,
                          customProfileView: widget.detailsConfiguration?.customProfileView,
                          disableUsersPresence: widget.detailsConfiguration?.disableUsersPresence ?? false,
                          hideProfile: widget.detailsConfiguration?.hideProfile,
                          listItemStyle: widget.detailsConfiguration?.listItemStyle,
                          subtitleView: widget.detailsConfiguration?.subtitleView,
                          privateGroupIcon: widget.detailsConfiguration?.privateGroupIcon,
                          protectedGroupIcon: widget.detailsConfiguration?.protectedGroupIcon,
                          statusIndicatorStyle: widget.detailsConfiguration?.statusIndicatorStyle,
                          ctheme: widget.detailsConfiguration?.theme ?? _theme,
                          onBack: widget.detailsConfiguration?.onBack,
                          onError: widget.detailsConfiguration?.onError,
                          groupMembersConfiguration: widget.detailsConfiguration?.groupMembersConfiguration,
                          leaveGroupDialogStyle: widget.detailsConfiguration?.leaveGroupDialogStyle,
                          stateCallBack: widget.detailsConfiguration?.stateCallBack,
=======
                          closeButtonIcon:
...
<<<<<<< HEAD
  Widget getMessageList(CometChatMessagesController controller, BuildContext context) {
=======
...
<<<<<<< HEAD
            ownColor: widget.messageListConfiguration.selfColor,
            otherColor: widget.messageListConfiguration.otherColor,
            ...
            showDateSeperator: widget.messageListConfiguration.showDateSeperator,
            replyEnabled: widget.messageListConfiguration.replyEnabled,
            //stateCallBack: messageListStateCallBack,
            messagesRequestBuilder: widget.messageListConfiguration.messagesRequestBuilder,
=======
...
<<<<<<< HEAD
            replyIcon: widget.messageListConfiguration.replyIcon,
            ...
            disableSoundForMessages:
                widget.messageListConfiguration.disableSoundForMessages ?? widget.disableSoundForMessages,
            ...
            customSoundForMessages:
                widget.messageListConfiguration.customSoundForMessages ?? widget.customSoundForIncomingMessages,
            messageListStyle: widget.messageListConfiguration.messageListStyle ?? const MessageListStyle(),
            sentIcon: widget.messageListConfiguration.sentIcon,
            readIcon: widget.messageListConfiguration.readIcon,
            onThreadRepliesClick:
                widget.messageListConfiguration.onThreadRepliesClick ?? controller.onThreadRepliesClick,
  ...
  Widget getMessageComposer(CometChatMessagesController controller, BuildContext context) {
    return widget.messageComposerView != null
        ? widget.messageComposerView!(controller.user, controller.group, context)
        : CometChatMessageComposer(
            user: controller.user,
            group: controller.group,
            placeholderText: widget.messageComposerConfiguration.placeholderText,
            actionOnSendButton: widget.messageComposerConfiguration.actionOnSendButton,
            hideLiveReaction: widget.messageComposerConfiguration.hideLiveReaction ?? false,
            ...
            sendButtonViewDisabled: widget.messageComposerConfiguration.sendButtonViewDisabled,
...
<<<<<<< HEAD
            ...
            messageComposerStyle: MessageComposerStyle(
              background: widget.messageComposerConfiguration.messageComposerStyle?.background ??
                  (widget.messagesStyle?.gradient != null ? Colors.transparent : widget.messagesStyle?.background),
              border: widget.messageComposerConfiguration.messageComposerStyle?.border ??
                  (widget.messagesStyle?.background != null || widget.messagesStyle?.gradient != null
                      ? null
              ...
              dividerTint: widget.messageComposerConfiguration.messageComposerStyle?.dividerTint ??
              ...
              contentPadding: widget.messageComposerConfiguration.messageComposerStyle?.contentPadding,
              replyTitle: widget.messageComposerConfiguration.replyTitleStyle,
              replySubTitle: widget.messageComposerConfiguration.replySubTitleStyle,
            ),
            ...
            disableSoundForMessages: widget.messageComposerConfiguration.disableSoundForMessages,
...
<<<<<<< HEAD
              color: widget.messagesStyle?.gradient == null ? widget.messagesStyle?.background : null,
              border: widget.messagesStyle?.border,
              borderRadius: BorderRadius.circular(widget.messagesStyle?.borderRadius ?? 0)),
=======
...
>>>>>>> 505e7ce063d0534c0c0b7a796b3601f100dee178
          child: GetBuilder(
              ...
              builder: (CometChatMessagesController value) {
                ...
                return Scaffold(
<<<<<<< HEAD
                  backgroundColor: widget.messagesStyle?.gradient != null || widget.messagesStyle?.background != null
=======
...
<<<<<<< HEAD
                          ? widget.messageHeaderView!(value.user, value.group, context)
                          : CometChatMessageHeader(
                              appBarOptions: widget.messageHeaderConfiguration.appBarOptions ??
                                  (User? user, Group? group, BuildContext context) {
                                    ...
                                    Widget? auxiliaryHeaderMenu = CometChatUIKit.getDataSource()
                                        .getAuxiliaryHeaderMenu(context, user, group, _theme);
                                    return [
                                      if (auxiliaryHeaderMenu != null) auxiliaryHeaderMenu,
                                      if (widget.hideDetails != true) detailsWidget(user, group, context)
=======
...
<<<<<<< HEAD
                              ctheme: widget.messageHeaderConfiguration.theme ?? _theme,
                              avatarStyle: widget.messageHeaderConfiguration.avatarStyle,
                              statusIndicatorStyle: widget.messageHeaderConfiguration.statusIndicatorStyle,
                              cbackButton: widget.messageHeaderConfiguration.backButton,
                              subtitleView: widget.messageHeaderConfiguration.subtitleView,
                              disableUserPresence: widget.messageHeaderConfiguration.disableUserPresence,
                              hideBackButton: widget.messageHeaderConfiguration.hideBackButton,
                              listItemStyle: widget.messageHeaderConfiguration.listItemStyle,
                              listItemView: widget.messageHeaderConfiguration.listItemView,
                              privateGroupIcon: widget.messageHeaderConfiguration.privateGroupIcon,
                              protectedGroupIcon: widget.messageHeaderConfiguration.protectedGroupIcon,
                              messageHeaderStyle: MessageHeaderStyle(
                                background: widget.messageHeaderConfiguration.messageHeaderStyle?.background ??
                                    (widget.messagesStyle?.background != null || widget.messagesStyle?.gradient != null
                                        ? Colors.transparent
                                        : null),
                                backButtonIconTint:
                                    widget.messageHeaderConfiguration.messageHeaderStyle?.backButtonIconTint,
                                border: widget.messageHeaderConfiguration.messageHeaderStyle?.border,
                                borderRadius: widget.messageHeaderConfiguration.messageHeaderStyle?.borderRadius,
                                gradient: widget.messageHeaderConfiguration.messageHeaderStyle?.gradient,
                                height: widget.messageHeaderConfiguration.messageHeaderStyle?.height,
                                width: widget.messageHeaderConfiguration.messageHeaderStyle?.width,
                                onlineStatusColor:
                                    widget.messageHeaderConfiguration.messageHeaderStyle?.onlineStatusColor,
                                subtitleTextStyle:
                                    widget.messageHeaderConfiguration.messageHeaderStyle?.subtitleTextStyle,
                                typingIndicatorTextStyle:
                                    widget.messageHeaderConfiguration.messageHeaderStyle?.typingIndicatorTextStyle,
=======
...
<<<<<<< HEAD
                          ...
                          //-----message composer-----
                          if (widget.hideMessageComposer == false) getMessageComposer(value, context)
                        ],
                      ),
                      if (value.isOverlayOpen == true) ...value.liveAnimationList
=======
