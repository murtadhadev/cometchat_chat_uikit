...
class CometChatMessageComposerController extends GetxController
    with CometChatMessageEventListener, CometChatUIEventListener, CometChatUserEventListener {
  ...
  _onTyping() {
    ...
    if (disableTypingEvents == false && userIsNotBlocked()) {
      if (_isTyping == false) {
...
//inserts emojis to correct position in the text
  ...
  bool userIsNotBlocked(){
    return user!=null &&  (user?.blockedByMe!=true && user?.hasBlockedMe!=true);
  }
