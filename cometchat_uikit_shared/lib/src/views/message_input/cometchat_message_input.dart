  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.all(Radius.circular(widget.style?.borderRadius ?? 8.0)),
      ),
      child: Column(
        children: [
          Container(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                hintText: widget.placeholderText ?? Translations.of(context).enter_your_message_here,
                hintStyle: TextStyle(
          ...
          if (widget.hideBottomView != true) Divider(height: 1, color: widget.style?.dividerTint),
          if (widget.hideBottomView != true)
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  gradient: widget.style?.gradient,
                  borderRadius: BorderRadius.only(
                      bottomLeft: Radius.circular(widget.style?.borderRadius ?? 8),
                      bottomRight: Radius.circular(widget.style?.borderRadius ?? 8))),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  //-----show add to chat bottom sheet-----
                  if (widget.secondaryButtonView != null) widget.secondaryButtonView!,
