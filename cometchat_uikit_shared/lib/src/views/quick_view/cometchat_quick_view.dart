...
class CometChatQuickView extends StatelessWidget {
  const CometChatQuickView({Key? key, required this.title, this.subtitle, this.ctheme, this.quickViewStyle})
      : super(key: key);
        ...
        Expanded(
          child: Container(
            decoration: BoxDecoration(
              color: quickViewStyle?.background ?? theme.palette.getBackground(),
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border(
                      left: BorderSide(
                        color: quickViewStyle?.leadingBarTint ?? theme.palette.getPrimary(), // Border color
