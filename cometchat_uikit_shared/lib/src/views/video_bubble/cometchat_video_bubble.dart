          ...
          children: [
            SizedBox.expand(
              child: thumbnailUrl != null && thumbnailUrl!.isNotEmpty
                  ? FadeInImage(
                      placeholder: AssetImage(placeHolderImage ?? AssetConstants.imagePlaceholder,
                      ...
                      image:
                          NetworkImageWithRetry(thumbnailUrl!, fetchStrategy: (Uri uri, FetchFailure? failure) async {
                        if (failure == null) {
                          return FetchInstructions.attempt(uri: uri, timeout: const Duration(seconds: 10));
                        }
