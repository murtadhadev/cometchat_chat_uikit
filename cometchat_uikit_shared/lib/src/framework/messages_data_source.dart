...
class MessagesDataSource implements DataSource {
  ...
  List<CometChatMessageOption> getTextMessageOptions(
    ...
    bool IsSentByMe = isSentByMe(loggedInUser, messageObject);
    ...
    return CometChatMessageTemplate(
      ...
      contentView: (BaseMessage message, BuildContext context, BubbleAlignment alignment) {
        ...
        return CometChatUIKit.getDataSource()
            .getTextMessageContentView(textMessage, context, alignment, theme, textStyle: textStyle);
      },
  ...
  Widget getTextMessageContentView(
    ...
    return CometChatUIKit.getDataSource()
        .getTextMessageBubble(message.text, message, context, alignment, theme, textStyle, null);
  }
  ...
  List<CometChatMessageOption> getCommonOptions(
    ...
    if (IsSentByMe == true && messageObject.deletedAt == null) {
      messageOptionList.add(getMessageInfo(context));
    }

    if (group != null && isSentByMe == false) {
      messageOptionList.add(getSendMessagePrivately(context));
    }

    if ((isSentByMe == true || memberIsNotParticipant == true) && messageObject.deletedAt == null) {
    ...
    return CometChatTextBubble(
      ...
      style: style ??
          TextBubbleStyle(
            ...
            width: style?.width,
            textStyle: TextStyle(
                    color: alignment == BubbleAlignment.right ? Colors.black : theme.palette.getAccent(),
                    fontWeight: theme.typography.body.fontWeight,
                    fontSize: theme.typography.body.fontSize,
