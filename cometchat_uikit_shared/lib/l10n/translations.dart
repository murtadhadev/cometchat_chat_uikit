...
abstract class Translations {
  ...
  static Translations of(BuildContext context) {
    return Localizations.of<Translations>(context, Translations) ?? TranslationsEn();
  }
  ...
  /// In en, this message translates to:
  /// **'Message Information'**
  String get message_information;

  /// No description provided for @send_message_privately.
  ///
  /// In en, this message translates to:
  /// **'Send Message Privately'**
  String get send_message_privately;
  ...
  /// In en, this message translates to:
  /// **'No Recipient'**
  String get no_recipient;

  /// No description provided for @receipt_information.
  ///
  /// In en, this message translates to:
  /// **'Receipt Information'**
  String get receipt_information;
  ...
  /// In en, this message translates to:
  /// **'No Call Logs Found'**
  String get no_call_logs_found;

  /// No description provided for @call_detail.
  ///
  /// In en, this message translates to:
  /// **'Call Detail'**
  String get call_detail;
  ...
  String get no_call_history_found;

  /// No description provided for @no_recordings_found.
  ///
  /// In en, this message translates to:
  /// **'No Recordings Found'**
  String get no_recordings_found;
  ...
  String get conversation_summary;
...
class _TranslationsDelegate extends LocalizationsDelegate<Translations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ar', 'de', 'en', 'es', 'fr', 'hi', 'lt', 'ms', 'pt', 'ru', 'sv', 'zh'].contains(locale.languageCode);
...
Translations lookupTranslations(Locale locale) {
  ...
  switch (locale.countryCode) {
    case 'TW': return TranslationsZhTw();
   }
  break;
   }
  }
  ...
  switch (locale.languageCode) {
    ...
    case 'hi': return TranslationsHi();
    case 'lt': return TranslationsLt();
    case 'ms': return TranslationsMs();
    case 'pt': return TranslationsPt();
    case 'ru': return TranslationsRu();
    case 'sv': return TranslationsSv();
    case 'zh': return TranslationsZh();
  }
